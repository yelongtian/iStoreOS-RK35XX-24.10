...
本仓库支持选择特定设备进行编译，可以大幅加快编译速度：

1. 进入 Actions 页面
2. 选择 "Build iStore OS 6.x" 工作流
3. 点击 "Run workflow"
4. 在 "device" 下拉菜单中选择要编译的设备（留空则编译所有设备）
...
华北工控 EMB-3531 是一款基于 RK3399 的嵌入式主板，本仓库已添加对其的支持：
